...
@sieve.function(
    name="video2dialogue_parallelized",
    python_packages=[
        "numpy>=1.19.0",
    ],
...
def video2dialogue_parallelized(youtube_url,voice1, voice2, image1 : sieve.File, image2: sieve.File):
    """
    ...
    with ThreadPoolExecutor() as executor:
        ...
        for speaker, text in summary_conversation_list:
            ...
            if turn % 2 != 0:  # Odd-turn of conversation
                target_audio_future = tts.push(voice1, text, reference_audio, "curiosity")
                ...
                target_audio_future = tts.push(voice2, text, reference_audio, "curiosity")
                avatar_video_future = portrait_avatar.push(
                    source_image=image2, 
                    driving_audio=target_audio_future.result(), 
                    aspect_ratio="16:9"
...
if __name__ == "__main__":
    ...
    output_video = video2dialogue_parallelized(youtube_url,odd_voice,even_voice,odd_image,even_image)
